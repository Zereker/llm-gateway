# deploy/observability — Monitoring & Alerting Configuration

llm-gateway ships a Prometheus `/metrics` endpoint. This directory contains a
provisioned dashboard, alert rules, and the scrape configuration used by the quickstart.
...
| `prometheus.yml` | Quickstart scrape and rule configuration |
