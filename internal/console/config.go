...
// call each other synchronously. They share internal/domain, internal/repo (including
// Scanner/Valuer + KEK encryption), internal/infra, and internal/endpointcheck, which
