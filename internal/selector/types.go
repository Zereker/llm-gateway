...
//     decisions all live in `internal/dispatch.Dispatcher` — selector only ever sees one batch of candidates
//
// **Call relationship** (since v0.6 dispatch owns scheduling sequencing; selector is reduced to the primitives layer):
//
//	internal/dispatch.Dispatcher.step (owner of scheduling sequencing)
...
//	    │
//	    └─ adapter: internal/dispatch/adapters/SelectorAdapter
