...
//	Selector    ── endpoint-selection abstraction (internal/selector, currently = internal/schedule)
//	Invoker     ── downstream-call abstraction (internal/invoker, currently = internal/upstream)
