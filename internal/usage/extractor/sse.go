...
// found. Lines within the event still carry a trailing \r; callers that parse
// individual lines should TrimSpace/TrimRight them (extractDataPayload does).
//
// Exported so the streaming translators share one frame boundary scanner
