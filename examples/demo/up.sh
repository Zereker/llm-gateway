...
COMPOSE=(docker compose -p llm-gateway-demo -f compose.yaml)
API_KEY="sk-demo-llm-gateway"
...
echo "[demo] building and starting the full stack"
"${COMPOSE[@]}" up --build -d --wait

echo "[demo] verifying the OpenAI-compatible request path"
...
echo
echo "llm-gateway demo is ready"
echo "  Gateway:       http://localhost:8080"
echo "  Console:       http://localhost:8081"
echo "  Console token: demo-admin-token"
